...
CREATE TABLE `employees` (
  ...
  `passportId` int(10) unsigned NOT NULL,
  ...
  KEY `dfghj` (`passportId`),
  CONSTRAINT `dfghj` FOREIGN KEY (`passportId`) REFERENCES `passports` (`passportId`),
  CONSTRAINT `employees_ibfk_1` FOREIGN KEY (`reportsTo`) REFERENCES `employees` (`employeeNumber`),
  CONSTRAINT `employees_ibfk_2` FOREIGN KEY (`officeCode`) REFERENCES `offices` (`officeCode`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO employees VALUES("1002","0","Murphy","Diane","x5800","dmurphy@classicmodelcars.com","1","","President");
INSERT INTO employees VALUES("1056","0","Patterson","Mary","x4611","mpatterso@classicmodelcars.com","1","1002","VP Sales");
INSERT INTO employees VALUES("1076","0","Firrelli","Jeff","x9273","jfirrelli@classicmodelcars.com","1","1002","VP Marketing");
INSERT INTO employees VALUES("1088","0","Patterson","William","x4871","wpatterson@classicmodelcars.com","6","1056","Sales Manager (APAC)");
INSERT INTO employees VALUES("1102","0","Bondur","Gerard","x5408","gbondur@classicmodelcars.com","4","1056","Sale Manager (EMEA)");
INSERT INTO employees VALUES("1143","0","Bow","Anthony","x5428","abow@classicmodelcars.com","1","1056","Sales Manager (NA)");
INSERT INTO employees VALUES("1165","0","Jennings","Leslie","x3291","ljennings@classicmodelcars.com","1","1143","Sales Rep");
INSERT INTO employees VALUES("1166","0","Thompson","Leslie","x4065","lthompson@classicmodelcars.com","1","1143","Sales Rep");
INSERT INTO employees VALUES("1188","0","Firrelli","Julie","x2173","jfirrelli@classicmodelcars.com","2","1143","Sales Rep");
INSERT INTO employees VALUES("1216","0","Patterson","Steve","x4334","spatterson@classicmodelcars.com","2","1143","Sales Rep");
INSERT INTO employees VALUES("1286","0","Tseng","Foon Yue","x2248","ftseng@classicmodelcars.com","3","1143","Sales Rep");
INSERT INTO employees VALUES("1323","0","Vanauf","George","x4102","gvanauf@classicmodelcars.com","3","1143","Sales Rep");
INSERT INTO employees VALUES("1337","0","Bondur","Loui","x6493","lbondur@classicmodelcars.com","4","1102","Sales Rep");
INSERT INTO employees VALUES("1370","0","Hernandez","Gerard","x2028","ghernande@classicmodelcars.com","4","1102","Sales Rep");
INSERT INTO employees VALUES("1401","0","Castillo","Pamela","x2759","pcastillo@classicmodelcars.com","4","1102","Sales Rep");
INSERT INTO employees VALUES("1501","0","Bott","Larry","x2311","lbott@classicmodelcars.com","7","1102","Sales Rep");
INSERT INTO employees VALUES("1504","0","Jones","Barry","x102","bjones@classicmodelcars.com","7","1102","Sales Rep");
INSERT INTO employees VALUES("1611","0","Fixter","Andy","x101","afixter@classicmodelcars.com","6","1088","Sales Rep");
INSERT INTO employees VALUES("1612","0","Marsh","Peter","x102","pmarsh@classicmodelcars.com","6","1088","Sales Rep");
INSERT INTO employees VALUES("1619","0","King","Tom","x103","tking@classicmodelcars.com","6","1088","Sales Rep");
INSERT INTO employees VALUES("1621","0","Nishi","Mami","x101","mnishi@classicmodelcars.com","5","1056","Sales Rep");
INSERT INTO employees VALUES("1625","0","Kato","Yoshimi","x102","ykato@classicmodelcars.com","5","1621","Sales Rep");
INSERT INTO employees VALUES("1702","0","Gerard","Martin","x2312","mgerard@classicmodelcars.com","4","1102","Sales Rep");
...
INSERT INTO orderdetails VALUES("10426","S18_1749","30","136.00","1");
INSERT INTO orderdetails VALUES("10426","S18_2248","50","55.09","2");
...
INSERT INTO orders VALUES("10167","2003-10-23","2003-10-30","","Cancelled","Customer called to cancel. The warehouse was notified in time and the order didn\'t ship. They have a new VP of Sales and are shifting their sales model. Our VP of Sales should contact them.","448");
...
INSERT INTO orders VALUES("10248","2004-05-07","2004-05-14","","Cancelled","Order was mistakenly placed. The warehouse noticed the lack of documentation.","131");
...
INSERT INTO orders VALUES("10260","2004-06-16","2004-06-22","","Cancelled","Customer heard complaints from their customers and called to cancel this order. Will notify the Sales Manager.","357");
INSERT INTO orders VALUES("10261","2004-06-17","2004-06-25","2004-06-22","Shipped","","233");
INSERT INTO orders VALUES("10262","2004-06-24","2004-07-01","","Cancelled","This customer found a better offer from one of our competitors. Will call back to renegotiate.","141");
...
INSERT INTO orders VALUES("10334","2004-11-19","2004-11-28","","On Hold","The outstaniding balance for this customer exceeds their credit limit. Order will be shipped when a payment is received.","144");
...
INSERT INTO orders VALUES("10401","2005-04-03","2005-04-14","","On Hold","Customer credit limit exceeded. Will ship when a payment is received.","328");
...
INSERT INTO orders VALUES("10407","2005-04-22","2005-05-04","","On Hold","Customer credit limit exceeded. Will ship when a payment is received.","450");
...
INSERT INTO orders VALUES("10414","2005-05-06","2005-05-13","","On Hold","Customer credit limit exceeded. Will ship when a payment is received.","362");
...
INSERT INTO orders VALUES("10420","2005-05-29","2005-06-07","","In Process","","282");
INSERT INTO orders VALUES("10421","2005-05-29","2005-06-06","","In Process","Custom shipping instructions were sent to warehouse","124");
INSERT INTO orders VALUES("10422","2005-05-30","2005-06-11","","In Process","","157");
INSERT INTO orders VALUES("10423","2005-05-30","2005-06-05","","In Process","","314");
INSERT INTO orders VALUES("10424","2005-05-31","2005-06-08","","In Process","","141");
INSERT INTO orders VALUES("10425","2005-05-31","2005-06-07","","In Process","","119");
INSERT INTO orders VALUES("10426","2005-05-31","2005-06-10","2005-06-11","In Process","","145");



DROP TABLE ordersArmen;

CREATE TABLE `ordersArmen` (
  `orderNUMBER` int(11) NOT NULL,
  `orderDate` date NOT NULL,
  `requiredDate` date NOT NULL,
  `shippedDate` date DEFAULT NULL,
